...
> 작성일: 2026-08-21 · 최종 갱신: 2026-08-26 (⧗ 표시 항목은 배포·촬영·이슈 제출 후 채운다)
...
- [x] README 의 명령이 실제로 동작한다 (`npx openccaudit` 을 리포 밖에서 실행해 확인)
- [x] CI 6개 잡이 그린이다
- [x] npm 배포 후 `npx openccaudit --help` 동작 (레지스트리 bin = `{ ccaudit: dist/cli.js }`)
- [ ] ⧗ 영상 3분 이내
